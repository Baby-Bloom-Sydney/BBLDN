...
export const PROFILE_STEPS: ReadonlyArray<ProfileStep> = Object.freeze([
  ...
  },
  {
    ...
    fields: ["yearsExperience", "ageGroups"],
  },
  {
    id: "qualification",
    heading: "Your childcare qualification",
    fields: ["qualification"],
  },
  {
    id: "certificates",
    heading: "Certificates you hold",
    fields: ["certificates"],
  },
  ...
  {
    id: "availability",
    heading: "When you're available",
    fields: ["availability"],
  },
  {
    id: "rate",
    heading: "Your rate and start date",
    fields: ["hourlyRateMin", "availableFrom"],
  },
