...
export function ContactStep({ badField }: { readonly badField?: string | null }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <input id="mobile" name="mobile" type="tel" inputMode="tel" autoComplete="tel" placeholder="07…" required className={FIELD_STYLES.input} {...invalid("mobile")} />
        <p className={FIELD_STYLES.hint}>We&rsquo;ll only use this to arrange introductions.</p>
      </div>
    </div>
  );
}
