...
const STEPS = [
  [
    "Apply",
    "About ten minutes — where you are, your experience, what you're looking for.",
  ],
  [
    "Verify",
    "Your ID, your DBS certificate and your right to work, checked by a person.",
  ],
  [
    "Be introduced",
    "A family near you who fits your days and your rate hears about you first.",
  ],
  ["Start", "Meet, agree the terms together, and do what you do best."],
] as const;

export function NannyEntryContent({
  applyHref,
  brandName,
}: NannyEntryContentProps) {
  return (
    <article className="mx-auto max-w-3xl px-4 py-12">
      <header>
        ...
        <p className="mt-4 text-base text-slate-700">
          {brandName} introduces experienced nannies to families across Greater
          London. You apply once; we do the finding.
        </p>
        <a
          href={applyHref}
          className="mt-6 inline-flex items-center rounded-md bg-violet-600 px-5 py-3 text-sm font-semibold text-white hover:bg-violet-700"
        >
          Apply to join
        </a>
      </header>
      <section aria-labelledby="why-heading" className="mt-12">
        <h2 id="why-heading" className="text-xl font-semibold text-slate-900">
          Why nannies choose us
        </h2>
      ...
      <section aria-labelledby="fit-heading" className="mt-12">
        <h2 id="fit-heading" className="text-xl font-semibold text-slate-900">
          You&rsquo;ll fit right in if
        </h2>
      ...
      <section aria-labelledby="how-heading" className="mt-12">
        <h2 id="how-heading" className="text-xl font-semibold text-slate-900">
          How it works
        </h2>
        ...
        <a
          href={applyHref}
          className="mt-8 inline-flex items-center rounded-md bg-violet-600 px-5 py-3 text-sm font-semibold text-white hover:bg-violet-700"
        >
