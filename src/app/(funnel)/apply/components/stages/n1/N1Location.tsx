...
export function N1Location({
  ...
  const showRightToWork =
    !autoRightToWork && (isAustralian || residency.residency_status !== null);
        ...
        <ProgressiveReveal show={showResidency}>
          <div className="flex flex-col gap-2 pt-2">
            ...
            <SingleSelectTags
              ...
              onChange={(val) => {
                const isAutoWork =
                  val === "Permanent Resident" || val === "Australian Citizen";
                update({
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg flex gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm text-blue-700">
                But we&apos;re growing! Complete your application and we&apos;ll
                let you know when we&apos;re in your area.
              </p>
            </div>
          </div>
        )}
