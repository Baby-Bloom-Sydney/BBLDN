...
import type { PositionStage, PositionStatus } from "@/lib/position/constants";
import type { AdminPosition } from "./page";
import { deriveDfyState, dfyStateBadge } from "./positions.helpers";
import { DfyPanel } from "./DfyPanel";
                  ...
                  return (
                    <Fragment key={pos.id}>
                      ...
                      >
                        ...
                        <TableCell>
                          {(() => {
                            const badge = dfyStateBadge(deriveDfyState(pos));
                            return (
...
function PositionDetail({
  ...
  return (
    <div className="space-y-4 px-6 py-4">
      ...
      {/* DFY · connections · placement — the comprehensive lifecycle view (T-047) */}
      <DfyPanel position={position} onOpenUser={onOpenUser} />
      <ConnectionsPanel
        connections={position.connections}
        perStageCounts={position.perStageCounts}
        onOpenUser={onOpenUser}
      />
      <PlacementPanel
        placement={position.activePlacement}
        onOpenUser={onOpenUser}
      />
    </div>
  );
