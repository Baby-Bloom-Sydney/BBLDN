// Cron shell for `/api/cron/usage-weekly-check` (01 §4e / §4f). Thin by rule: it delegates to `runCron`, which is the one place the
...
const PATH = "/api/cron/usage-weekly-check";
