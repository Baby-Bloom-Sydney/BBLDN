...
// ports built over `auth`'s data port, then the three service seams. Every binding is chosen by the parsed env
// (05 §3 rule 1); a port left on its fail-closed default carries its reason on the report, never silence.
