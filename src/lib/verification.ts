...
export type CrossCheckStatus =
  (typeof CROSS_CHECK_STATUS)[keyof typeof CROSS_CHECK_STATUS];
...
export const GUIDANCE_MESSAGES = {
  TECHNICAL_RETRY: {
    ...
    explanation:
      "We experienced a temporary technical issue while processing your documents.",
    steps_to_fix: [
  ...
  TECHNICAL_STALE: {
    ...
    explanation:
      "Your documents have been saved safely. You can try again now or come back later.",
    steps_to_fix: [
  ...
  PDF_UNREADABLE: {
    ...
    explanation:
      "The PDF you uploaded may not be the correct file, or may not have been saved correctly.",
    steps_to_fix: [
  ...
  PDF_NAME_MISMATCH: {
    ...
    explanation:
      "The name extracted from your WWCC grant email is different from the name you provided.",
    steps_to_fix: [
  ...
  WWCC_EXPIRED: {
    ...
    explanation:
      "The Working With Children Check on this document has passed its expiry date.",
    steps_to_fix: [
  ...
  WWCC_OCG_NOT_FOUND: {
    ...
    explanation:
      "We have been notified by the Office of the Children's Guardian that the WWCC number accompanied with your Surname and Date of Birth could not be found. In order for us to keep supporting you as a childcare professional you must first re-submit your WWCC verification.",
    steps_to_fix: [
  ...
  WWCC_EXPIRED_OCG: {
    title: "Your WWCC has expired",
    explanation:
      "The Office of the Children's Guardian has confirmed that your Working With Children Check has expired. You will need to apply for a new WWCC before you can continue working with children.",
    steps_to_fix: [
  ...
  WWCC_CLOSED_OCG: {
    ...
    explanation:
      "The Office of the Children's Guardian has indicated that your WWCC application has been closed. You will need to submit a new application to obtain a valid Working With Children Check.",
    steps_to_fix: [
      "Apply for a new WWCC at https://www.ocg.nsw.gov.au/working-with-children-check",
      "Once you receive your new clearance, come back and resubmit your WWCC verification",
    ],
  ...
  WWCC_APPLICATION_PENDING: {
    ...
    explanation:
      "The Office of the Children's Guardian has confirmed that your WWCC application is still in progress and has not yet been decided. You cannot be fully verified until your WWCC application has been approved.",
    steps_to_fix: [
  ...
  WWCC_BARRED: {
    ...
    explanation:
      "The Office of the Children's Guardian has indicated that you are not eligible to hold a Working With Children Check. Your Baby Bloom account has been suspended and you are unable to use our services.",
    steps_to_fix: [
...
export const PARENT_VERIFICATION_LEVEL = {
  UNVERIFIED: 0,
  VERIFIED: 1,
} as const;
...
export type ParentIdentityStatus =
  (typeof PARENT_IDENTITY_STATUS)[keyof typeof PARENT_IDENTITY_STATUS];
...
export const PARENT_GUIDANCE_MESSAGES = {
  NAME_MISMATCH: {
    ...
    explanation:
      "The information you entered doesn't match what's printed on your document.",
    steps_to_fix: [
  ...
  DOB_MISMATCH: {
    ...
    explanation:
      "The date of birth you entered doesn't match what's on your document.",
    steps_to_fix: [
      "Check your date of birth matches your document exactly",
      "Re-enter your details and try again",
    ],
  ...
  EXPIRED_DOCUMENT: {
    ...
    steps_to_fix: ["Upload a valid, non-expired passport or driver's license"],
  },
  INVALID_DOCUMENT: {
  ...
  SELFIE_LOW_CONFIDENCE: {
    title: "We were unable to verify your ID",
    explanation:
      "We were not able to match your ID to your selfie with high confidence.",
    steps_to_fix: [
      "Face the camera directly with your whole face clearly visible",
      "Use good, even lighting — natural light works best",
...
export function deriveOverallStatus(
  ...
  if (identityStatus === "processing")
    return VERIFICATION_STATUS.PENDING_ID_AUTO;
  ...
  if (crossCheckStatus === "passed")
    return VERIFICATION_STATUS.PROVISIONALLY_VERIFIED;
  if (crossCheckStatus === "review")
    return VERIFICATION_STATUS.PROVISIONALLY_VERIFIED;

  // ── 4. WWCC statuses (only reachable when identity = verified) ──
  if (wwccStatus === "doc_verified")
  ...
  if (wwccStatus === "ocg_not_found")
    return VERIFICATION_STATUS.WWCC_OCG_NOT_FOUND;
  if (wwccStatus === "closed") return VERIFICATION_STATUS.WWCC_CLOSED;
  if (wwccStatus === "application_pending")
    return VERIFICATION_STATUS.WWCC_APPLICATION_PENDING;
