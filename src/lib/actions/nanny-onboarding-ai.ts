...
export async function generateOnboardingAIContent(
  leadId: string,
  ...
  try {
    ...
    const userMessage = buildV2Prompt({
      ...
      highestQualification: qualifications.has_qualifications
        ? qualifications.highest_qualification
        : null,
      certificates: qualifications.has_certificates
