...
`../SPECS/00-foundations/` (linked sibling checkout — ADR-107), never here.
...
| The foundations (facts + ADRs)                              | `../SPECS/00-foundations/` — start at its `README.md`, then `DECISIONS.md` |
| Build state, known bugs, next unit                          | [`docs/build-progress.md`](./docs/build-progress.md)                       |
| Merged units                                                | [`CHANGELOG.md`](./CHANGELOG.md)                                           |
| Team coordination (tasks, branches, protocols)              | `../OPERATIONS/` (`INDEX.md`, `BRANCHES.md`, `PROTOCOLS/`)                 |
