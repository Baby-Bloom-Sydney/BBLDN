...
describe("db.constraints — the schema-wide conventions", () => {
  ...
  it("the schema is the 61 tables and 9 views of 02 §4 and §7 (56 + rate_limit_buckets 0017 + position_call_mirror 0018 + nanny_suspension_lifts 0025 + file_retention_log and account_erasure_requests 0028)", async () => {
    ...
    expect(Number(rows[0].tables)).toBe(61);
